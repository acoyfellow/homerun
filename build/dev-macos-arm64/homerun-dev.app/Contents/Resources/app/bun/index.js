...
// src/bun/capture/recorder.ts
function createRecorder(filter) {
...
// src/bun/proxy/tunnel.ts
function handleConnect(_req, url) {
...
var { interceptor, addHook } = createInterceptor();
